...
//--------------------------New------------------------------------------------------------------
//void Solve::initializeGridRandom() {
...
//    clearGrid();
//
//    // Remplir la grille avec des nombres aléatoires tout en respectant les règles du Sudoku
//    for (int num = 1; num <= 9; ++num) {
//        // Placer le nombre dans une position aléatoire de chaque bloc de 3x3
//        for (int blockRow = 0; blockRow < 3; ++blockRow) {
//            for (int blockCol = 0; blockCol < 3; ++blockCol) {
//                int row, col;
//                do {
//                    row = blockRow * 3 + std::rand() % 3;
//                    col = blockCol * 3 + std::rand() % 3;
...
//    }
//
//    // Afficher la grille dans l'interface utilisateur
//    //DisplayGrid();
//}
//
//void Solve::clearGrid() {
//    for (int i = 0; i < 9; ++i) {
//        for (int j = 0; j < 9; ++j) {
//            grid2[i][j] = 0;
//        }
